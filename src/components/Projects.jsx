                     ...
                     <div className="proyecto">
                        ...
                        <div className="overlay">
                           ...
                           <div className="d-flex gap-2 flex-wrap justify-content-center px-1">
                              ...
                              <h6>
                                 <span className="badge text-bg-primary">Node</span>
                              </h6>
                              <h6>
                           ...
                           <div className="iconos-contenedor">
                              <a
                                 href="https://github.com/salva5/Nonflix"
                                 target="_blank"
                              ...
                              <a
                                 href="https://nonflix-kappa.vercel.app"
                                 target="_blank"
                                 rel="noopener noreferrer"
                              >
                  ...
                  <div className="col-12 col-md-6 col-lg-4">
                     <div className="proyecto">
                        ...
                        <div className="overlay">
                           ...
                           <div className="iconos-contenedor">
                              <a
                                 href="https://github.com/salva5/PI_Pokemon"
                                 target="_blank"
                                 rel="noopener noreferrer"
                              >
                                 <i className="bi bi-github"></i>
                  ...
                  <div className="col-12 col-md-6 col-lg-4">
                     <div className="proyecto">
                        ...
                        <div className="overlay">
                           ...
                           <div className="iconos-contenedor">
                              <a
                                 href="https://github.com/salva5/Batalla-de-Mokepones"
                                 target="_blank"
                                 rel="noopener noreferrer"
                              >
                                 <i className="bi bi-github"></i>
                  ...
                  <div className="col-12 col-md-6 col-lg-4">
                     <div className="proyecto">
                        ...
                        <div className="overlay">
                           ...
                           <div className="iconos-contenedor">
                              <a
                                 href="https://github.com/salva5/NextLevel"
                                 target="_blank"
                                 rel="noopener noreferrer"
                              >
                                 <i className="bi bi-github"></i>
                              ...
                              <a
                                 href="https://salva5.github.io/NextLevel/"
                                 target="_blank"
                                 rel="noopener noreferrer"
                              >
                                 <i className="bi bi-laptop"></i>
